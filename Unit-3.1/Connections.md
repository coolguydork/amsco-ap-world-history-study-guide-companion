...
topic: 3.1
period: 2
tags: [apwh, unit-3, topic-3-1, period-2, connections, land-based-empires, gunpowder-empires, ottoman, safavid, mughal]
---
...
**Gunpowder technology and empire** — The through-line of Topic 3.1. Track how the same technology (originating in China) produced different political outcomes in different regions.

**Centralization of power** — Every empire in this topic pursued it; every empire declined when it failed. Use this as your scaffolding for any GOV essay.

**Religious legitimacy of rulers** — Ottoman sultans as Sunni caliphs, Safavid shahs as protectors of Shia Islam, Mughal emperors navigating Hindu-Muslim relations, Russian tsars as defenders of Orthodoxy. Religion was never separate from politics.

**Military innovation** — Gunpowder weapons, Cossack cavalry, janissary infantry, European mercenaries (Safavid). Track how states adapted — or failed to adapt — to changing military technology.

---

## Concept Notes

- [[Concept Notes/Mongols|Mongols]] — direct predecessors; Tamerlane as bridge figure
- [[Concept Notes/Sufism|Sufism]] — Safavid dynasty originated in a Sufi order; Sufism spread Islam along trade routes
- [[Concept Notes/Silk Roads|Silk Roads]] — trade routes the gunpowder empires fought to control
- [[Concept Notes/Syncretism|Syncretism]] — Akbar's religious tolerance is a form of cultural syncretism
- [[Concept Notes/Tribute System|Tribute System]] — used by Qing China to manage relations with neighboring states
- [[Concept Notes/Indian Ocean Trade Network|Indian Ocean Trade Network]] — Mughal India's overseas trade in textiles and spices
