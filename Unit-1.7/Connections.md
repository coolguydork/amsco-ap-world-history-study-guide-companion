...
topic: 1.7
period: 1
tags: [apwh, unit-1, topic-1-7, period-1, comparison, state-building, trade-networks, governance]
---

# Connections — Topic 1.7
**Topic 1.7 | Unit 1: The Global Tapestry | Period 1 (c. 1200–c. 1450)**
*AMSCO pp. 65–68*

Topic 1.7 is the synthesis topic of Unit 1. Every prior topic feeds directly into it.

---

## Builds On: All Unit 1 Topics

Topic 1.7 draws all six Unit 1 regional topics together for comparison. Its content *is* the synthesis of 1.1–1.6.

**[[Unit-1.1/East Asia Overview|East Asia Overview]] [[Unit-1.1/East Asia Overview|East Asia Overview]]**
...
The Aztec and Inca empires are the primary American examples of "Expansion in Scope." Their state-building methods — tributary extraction (Aztec) and mit'a labor service (Inca) — contrast with both each other and with Eurasian models. The absence of centralized states across most of the Americas is also exam-relevant. See also [[Unit-1.4/Themes & Historical Reasoning|Themes & Historical Reasoning]].

**[[Unit-1.5/Africa Overview|Africa Overview]] [[Unit-1.5/Africa Overview|Africa Overview]]**
The Mali Empire is the primary African example, illustrating both "Revival of Former Empires" (building on Ghana) and Islam as a source of legitimacy. Mansa Musa's pilgrimage and Ibn Battuta's account are the key primary sources for DBQ analysis. See also [[Unit-1.5/People, States & Movements|People, States & Movements]].

**[[Unit-1.6/Medieval Europe Overview|Medieval Europe Overview]] [[Unit-1.6/Medieval Europe Overview|Medieval Europe Overview]]**
Europe provides the contrast case: state-building was slower and more contested than in Asia, held back by the manorial system, serfdom, and competition between monarchs and the Church. The Holy Roman Empire illustrates "Revival of Former Empires." [[Concept Notes/Feudalism|Feudalism]] is the European parallel to Japan's decentralization. See also [[Unit-1.6/Themes & Historical Reasoning|Themes & Historical Reasoning]].

---

## Leads To: All Unit 2 Topics
...
## AP Threads Running Through 1.7

**Comparison of state-building methods** — the explicit skill of this topic; any AP LEQ on Unit 1 will draw on this

**Religion as a tool of political legitimacy** — cross-regional similarity that appears in every region covered in Unit 1

**Trade and state wealth** — connecting the Silk Roads, Indian Ocean, and trans-Saharan networks to specific states' power (Song, Mali, Chola)

**Nomadic vs. settled peoples** — the Mongol and Turkish impact on settled agricultural states; the waning of nomadic power by c. 1450

**Patriarchy as social continuity** — with foot binding (China), convents (Europe), and Jainist communities (South Asia) as exam-relevant variations
