...
topic: "5.6"
period: 3
tags: [apwh, unit-5, topic-5-6, period-3, industrialization, governance, connections]
---
...
A dedicated Concept Note exists for the Meiji Restoration, collecting cross-topic context. The Restoration appears in Unit 5 (government-directed industrialization), Unit 6 (Japan as imperial power, Russo-Japanese War), and Unit 7 (Japan in WWI and WWII). Always link to this note from relevant topic notes.

---

## Comparison Connections

| Comparison | AP Relevance |
|---|---|
| Japan vs. Ottoman Empire | Classic divergence comparison — same external pressure, opposite outcomes |
| Japan vs. Britain | State-directed vs. private industrialization; speed vs. organic growth |
| Muhammad Ali's Egypt vs. Meiji Japan | Both use state direction and agricultural taxes; Egypt fails, Japan succeeds |
| Meiji Japan vs. Russia (Alexander II) | Both abolish forms of feudal labor (serfdom / feudalism) to enable industrialization; Japan faster and more complete |
| Japan (1868) vs. China (Qing reforms) | Similar external pressure; Japan succeeds, China's reforms (Self-Strengthening Movement) largely fail |
...
> [!exam-tip]
> Topic 5.6 is one of the most comparison-heavy topics in AP World History. Every major concept here pairs with something else: Japan pairs with the Ottomans (divergence), with Britain (method), with China (outcome). When you study this topic, always ask: "Compared to what?" That's the exam's lens for this content.
