...
topic: 1.1
period: 1
tags: [apwh, unit-1, topic-1-1, period-1, east-asia, governance, cultural-diffusion]
---

# People, States & Movements — Topic 1.1: Developments in East Asia
*AMSCO pp. 1–14*
...
Founder of the Song Dynasty. His most significant contribution was expanding the **civil service exam** to include young men from lower economic classes — not just the hereditary aristocracy. This created a more merit-based bureaucracy and produced the **scholar-gentry** class that would define Chinese society for centuries.

> [!exam-tip]
> Song Taizu = meritocracy + civil service expansion. Remember his role when the AP asks about Chinese governance or social mobility.
...
Leader of the Minamoto clan and first shogun of Japan's **Kamakura Shogunate** (1192–1333). Though Japan retained its emperor, Minamoto Yoritomo's installation as shogun made him the real political power. This marks the beginning of Japan's feudal era, in which military commanders (shoguns) and local lords (daimyo) dominated politics.
...
| Feature | Detail |
|---------|--------|
| Founded by | Song Taizu after Tang collapse |
| Territory | Smaller than Tang (lost north to Jin Empire) |
| Government | Imperial bureaucracy + meritocratic civil service |
| Economy | Commercialized; porcelain, silk, tea exports; Grand Canal; proto-industrialization |
| Society | Scholar-gentry dominant class; foot binding spreads |
| Religion | Buddhism + Neo-Confucianism synthesis |
| End | Conquered by Kublai Khan's Mongols (1279) |
...
Japan's first shogunate, established by the Minamoto clan. The shogun was the effective military ruler; the emperor retained symbolic power only. Japan's feudal structure during this period featured daimyo (lords), samurai (warriors), and peasant serfs — structurally similar to European feudalism but with key differences (see below).

---

## Comparative Table: Japanese vs. European Feudalism

| Feature | Japanese Feudalism | European Feudalism |
|---------|-------------------|-------------------|
| Top political authority | Emperor (symbolic) → Shogun (real power) | Monarch (real power) |
| Warrior class | Samurai | Knights |
| Lords | Daimyo (more powerful than emperor) | Nobles (below monarch) |
| Peasants | Serfs; hereditary dependency | Serfs; hereditary dependency |
| Warrior code | Bushido (frugality, loyalty, martial arts, honor) | Chivalry (duty to God, women, countrymen) |
| Social mobility | Very limited; hereditary | Very limited; hereditary |

> [!exam-tip]
> AP loves this comparison. Japan's daimyo were MORE powerful relative to the political center than European nobles were. Both systems had very little social mobility and hereditary hierarchies.
