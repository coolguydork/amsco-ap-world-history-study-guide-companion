...
| Topic 2.6 Example | Comparable Example Elsewhere | AP Use |
|-------------------|------------------------------|--------|
| Champa rice boosts China's population | Green Revolution boosts 20th-c. populations (Topic 9) | Causation + comparison |
| Bananas enable Bantu migration | Columbian Exchange crops enable European settlement in Americas | Comparison |
| Black Death via Silk Roads | Smallpox via Columbian Exchange routes | Comparison — biological consequences of connectivity |
| Feudal decline post-plague | Atlantic economy replacing feudal economy | CCOT |

## AP Threads Running Through This Topic

**Environment as agent of history** — The most important AP thread in 2.6 is that environmental forces (disease, climate, soil exhaustion) aren't just background — they actively reshape political and economic systems. The Black Death's destruction of feudalism is the clearest example.

**Connectivity has costs** — Every AP period has a version of this: trade networks create prosperity AND vulnerability. Disease, invasive species, and resource exhaustion are all costs of integration. 2.6 is the clearest pre-modern illustration of this principle.

**Demographics matter** — Population size drives agricultural expansion; population collapse drives economic transformation. The AP exam frequently tests whether students understand demographic change as a cause, not just an effect.
